            ...
            <table id="datatable" class="table table-bordered">
              ...
              <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                <tr>
                  ...
                  <td>
                    <a href="?page=jenis&aksi=ubah&id=<?= $row['kd_jenis']; ?>" class="btn btn-warning">EDIT</i></a>
                    <a href="?page=jenis&aksi=hapus&id=<?= $row['kd_jenis']; ?>" class="btn btn-danger" onclick="return confirm('Apakah anda yakin untuk menghapus ?');">DELETE</i></a>
                  </td>
                </tr>
              <?php $i++; ?>
              <?php endwhile; ?>
