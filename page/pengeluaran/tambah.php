...
if (isset($_POST['tambah'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO `tb_pengeluaran` (`id_pengeluaran`, `tgl_pengeluaran`, `catatan`, `pengeluaran`) 
                                  VALUES ('$id_pengeluaran', '$tanggal', '$catatan', '$pengeluaran')");
